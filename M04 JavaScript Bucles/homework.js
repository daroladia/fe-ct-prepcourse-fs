...
function operadoresLogicos(num1, num2, num3) {
   ...
   // Tu código:
   //esto es raor por que se pueden cumplir varias condiciones a la vez y si uso return entonces estoy siempre omitiendo la posibilidad de que se cumplan las otras condiciones
   //podria usar consolo.log o print o algo asi pero el ejercicio no me daria. igualmente me lo toma como OK por lo que no entiendo que pasa.
...
function tieneTresDigitos(num) {
   ...
   // Tu código:
      const numeroString = Math.abs(num).toString();
